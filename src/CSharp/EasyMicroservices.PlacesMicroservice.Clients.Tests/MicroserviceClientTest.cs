...
namespace EasyMicroservices.PlacesMicroservice.Clients.Tests
{
...
{""result"":[],""isSuccess"":true,""error"":null}");
        ...
        public async Task GetAllTestTest()
        {
            ...
            //await OnInitialize();
            //var microserviceClient = new Places.GeneratedServices.MicroserviceClient(_routeAddress, HttpClient);
